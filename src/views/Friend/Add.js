...
define(function(require, exports, module) {
    ...
    // Subviews
    var CreateView      = require('./Subviews/Create');
    var EnterView      = require('./Subviews/Enter');
    ...
    PageView.prototype.createHeader = function(){
        ...
        this.header._eventOutput.on('back',function(){
            App.Data.User.fetch(); // fetch, in case
            // App.Events.trigger('user_collection_fetch');
            App.history.back();
        });
